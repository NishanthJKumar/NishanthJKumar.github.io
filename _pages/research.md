    ...
    <tbody>
      <tr bgcolor="#ffffd0">
        <td style="padding:20px;width:25%;vertical-align:middle">
          <div>
            <img src='/images/paper-images/ptp-img.png' width="160">
          </div>
        </td>
        <td style="padding:20px;width:75%;vertical-align:middle">
          ...
          <a href="https://lfzhao.com/">Linfeng Zhao</a>,
          <a href="https://www.linkedin.com/in/stephen-proulx/?trk=public_profile_samename-profile">Stephen Proulx</a>,
          ...
          /
          <a href="https://arxiv.org/abs/2402.15025">arxiv</a>
          <br>
          <p>
          Introduces a new framework for robots to improve performance by efficiently learning online <em>during deployment</em>. Demonstrates that the proposed approach and framework can be implemented on a real robot and help significantly improve its ability to solve complex, long-horizon tasks in the real-world with no human intervention or environment resets!
          <br>
...
<table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;">
        <tbody>
          <tr>
            <td style="padding:20px;width:25%;vertical-align:middle">
              <div>
                <img src='/images/paper-images/plga-img.png' width="160">
              </div>
            </td>
            <td style="padding:20px;width:75%;vertical-align:middle">
              <p style="font-family:'Lato',Verdana,Helvetica,sans-serif; font-size:14px;font-weight:700">
              ...
              <a href="https://andipeng.com/">Andi Peng</a>,
              <a href="https://andreea7b.github.io/">Andreea Bobu</a>,
              <a href="https://belindal.github.io/">Belinda Z. Li</a>,
              ...
              <br>
              <a href="https://arxiv.org/pdf/2402.03081.pdf">paper</a>
              <br>
              <p>Introduces a method for enabling a robot to learn state abstractions for solving tasks that are tailored to a human's specific preferences.<br>
              </p>
            </td>
          </tr>
        </tbody>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="padding:20px;width:75%;vertical-align:middle">
          ...
          <a href="https://cs.brown.edu/people/gdk/">George Konidaris</a>
          <br>
          <em>IJCAI Workshop on Bridging the Gap Between AI Planning and Reinforcement Learning</em>, 2023.
          <br>
          <a href="http://irl.cs.brown.edu/pubs/task_scoping_prl2023.pdf">paper</a>
          <br>
          <p>
...
- [NVIDIA Research](https://www.nvidia.com/en-us/research/), Seattle, USA. <br/> Working with [Caelan Garrett](https://web.mit.edu/caelan/www/), [Fabio Ramos](https://fabioramos.github.io/Home.html), and [Dieter Fox](https://homes.cs.washington.edu/~fox/) in the [Seattle Robotics Lab](https://research.nvidia.com/labs/srl/) on combining ideas from TAMP with foundation models for real-world tasks. Stay tuned for more!
- [The AI Institute](https://theaiinstitute.com/), Cambridge, USA. <br/>Worked with [Jennifer Barry](https://www.linkedin.com/in/jennifer-barry-742a0799/) and many other wonderful researchers on combining planning and learning to enable robots to solve real-world long-horizon tasks. These efforts have resulted in one publication (so far), check it out [here](https://planning-to-practice.github.io/)! I was also the first ever intern to start at the AI Institute :).
