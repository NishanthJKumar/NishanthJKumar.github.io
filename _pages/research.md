...
- [NVIDIA Researc](https://www.nvidia.com/en-us/research/), Seattle, USA. <br/> Working with [Caelan Garrett](https://web.mit.edu/caelan/www/), [Fabio Ramos](https://fabioramos.github.io/Home.html), and [Dieter Fox](https://homes.cs.washington.edu/~fox/) in the [Seattle Robotics Lab](https://research.nvidia.com/labs/srl/) on combining ideas from TAMP with foundation models for real-world tasks. Stay tuned for more!
