...
There are already a number of good articles on whether to do an AI PhD or not (see [this](https://jasonppy.github.io/story/worst-time-AI-phd/), [this](https://jasonppy.github.io/story/best-time-AI-phd/), [this](http://yingzhenli.net/home/en/?page_id=1083), [this](https://www.gleave.me/post/why-do-phd/), and [this](https://yashbhalgat.github.io/blog/phd-or-not-phd.html)). These generally discuss the "pros" and "cons" of a PhD, and I won't repeat them here. Instead, I want to share a different framing that I've found much more useful for actually making the decision.

## Optimize for fun

One of the best pieces of career advice I've read is [this essay](https://medium.com/@black_51980/the-fallacy-of-the-globally-optimal-career-74751a4834bb) by Michael Black. I strongly resonate with everything he says: making the optimal career decision at every step is not something that can be planned out. There are too many unknowns, too much randomness, and too many things that will change between now and the future you're trying to optimize for. Given this, optimizing for "fun" turns out to be quite a good heuristic.
...
If any of this has been helpful, or if you'd like to share your own experience with making this decision, feel free to [reach out](https://nishanthjkumar.com/contact-me/) — I'd love to hear from you.

*Thanks to [Josh Roy](https://joshnroy.github.io/), and [Tom Silver](https://tomsilver.github.io/) for reviewing early drafts of this post and providing helpful feedback.*